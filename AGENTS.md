...
is needed, give an outline of the concepts and present one concept in-depth at
a time. When the prompter is satisfied with a concept they will ask to move to
the next one.

## Seek alignment before edits

Before making any edit, surface your thinking and get agreement. Cover
whichever of the following apply. Skip what does not.
